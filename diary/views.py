...
def indexView(request):
    return diaryView(request, 'all', 0, 0, 0, 0, 1)

def diaryView(request, title_id, subtitle_id, year, month, day, page_no):
    year = int(year)
    month = int(month)
    day = int(day)
    ...
    if title_id == 'all':
        ...
        if subtitle_id == 0 and year == 0 and month == 0 and day == 0:
    ...
    return render(request,
                  ...
                  {'diary': view_diary, 'page_list': page_list[start_page_no:end_page_no],
                   ...
                   'title_id': title_id, 'subtitle_id': subtitle_id,
                   'year': year, 'month': month, 'day': day,
                   'title_list': title_list, 'subtitle_list': subtitle_list,
